...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _converter = __webpack_require__(18);
	...
	function Main(props) {
	    return _react2.default.createElement(
	        'div',
	        { className: 'style-converter-wrapper' },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Converter = function (_React$Component) {
	  ...
	  function Converter(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, (Converter.__proto__ || Object.getPrototypeOf(Converter)).call(this, props));
	  ...
	  _createClass(Converter, [{
	    ...
	    value: function convert() {
	      ...
	      xmlhttp.send(JSON.stringify({ input: input }));
	    }
	  }, {
	    key: 'render',
...
/***/ (function(module, exports) {
	...
	var updateState = function updateState(_inst) {
	    _inst.setState({
	        _: ''
	    });
	};
